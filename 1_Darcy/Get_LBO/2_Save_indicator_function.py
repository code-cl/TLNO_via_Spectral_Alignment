...
if __name__ == '__main__':
    ...
    # Points_C = sio.loadmat('../Data/Shape_C/Nodes_LBO_basis.mat')['Points']
    ...
    for i in range(n):
        ...
        Ind_A.append(compute_fourier_series(Points_A, modes_i, coeffs_i, is_sine_i))
        Ind_B.append(compute_fourier_series(Points_B, modes_i, coeffs_i, is_sine_i))
        # Ind_C.append(compute_fourier_series(Points_C, modes_i, coeffs_i, is_sine_i))
    ...
    # sio.savemat('../Data/Shape_C/Indicator_function.mat', {'value': Ind_C})
