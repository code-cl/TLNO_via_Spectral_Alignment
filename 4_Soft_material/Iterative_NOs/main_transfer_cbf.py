...
def JAD_lbo(Reference_lbo_path, Couple_lbo_path, Reference_data, Couple_data, n_lbo):
...
if __name__ == "__main__":
    ...
    source_shape = 'Petals3_data'
    target_shape = 'Petals4_data'
    data_path = '../Data/' + target_shape
    save_path = '../logs/' + source_shape + '→' + target_shape
    Source_lbo_path = '../Data/' + source_shape + '/Nodes_LBO_basis'
    Target_lbo_path = '../Data/' + target_shape + '/Nodes_LBO_basis'
    
    source_model_str = 'NORM_plus_ntr5000_nte2000_L2_nl8_nm64_nc128_nh8_AdamW_OneCycleLR'
    source_model_path = '../logs_0328/' + source_shape + '/' + source_model_str
    ...
    # Read data
    lbo_data = sio.loadmat(Target_lbo_path)
    nodes  = lbo_data['Points']
    
    print('data_path:', data_path)
    da = sio.loadmat(data_path + '/data.mat')     
    x_data = da['input']
    y_data = da['output']
