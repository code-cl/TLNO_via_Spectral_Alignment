...
def main(args):
    ...
    #u_pred = tf.concat([ux_pred, uy_pred], axis=-1)
    ...
    while n <= nmax:
        ...
        if n%1 == 0:
            ...
            for i in range(ni):
                ...
                test_id, x_test, f_test, u_test = data.testbatch(bs, batch_id) #bs
    ...
    print('source_data', ntr, args['source_nte'])
...
if __name__ == "__main__":
    ...
    for n_train in n_trains:
        ...
        args['epochs']     = 1000 # 50000
        current_directory = os.getcwd()    
        case = "../logs/"+geo_list[source_geo]+ '/' + str(n_i) +"/DeepONetBST_Ntr" + str(args['source_ntr'])\
            ...
            with open(txt_path, "w") as f:
                ...
                for key, value in args.items():
                    if key == 'x_data' or key == 'y_data' or key == 'nodes' or key == 'elems' or key == 'Data_modes':
                        continue  # 跳过 'data'
                    f.write(f"{key}: {value}\n")
        sio.savemat(current_directory + "/" + case + '/err_results.mat', {'value': err_results})
